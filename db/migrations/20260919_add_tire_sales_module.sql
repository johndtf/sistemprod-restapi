-- Ventas registra la factura ya emitida por contabilidad y controla el paso
-- logistico de una llanta procesada desde una bodega hasta el cliente.

CREATE TABLE IF NOT EXISTS `ventas_llantas` (
...
CREATE TABLE IF NOT EXISTS `ventas_llantas_detalle` (
